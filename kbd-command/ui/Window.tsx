        ...
        <Dialog className="fixed inset-0 z-10" onClose={() => setIsOpen(false)}>
          <div className="min-h-screen flex justify-center">
            ...
            <Transition.Child
              ...
              <div className="bg-white dark:bg-black border border-gray-100 dark:border-gray-700/60 w-[640px] sm:h-[423px] px-[1px] transform mt-[180px] shadow-2xl dark:shadow-xl rounded-lg relative">
                {children}
              </div>
            </Transition.Child>
          </div>
